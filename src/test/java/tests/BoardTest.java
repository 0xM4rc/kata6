...
public class BoardTest {
    ...
    public void should_return_2x2_board_with_all_alive_cells_given_2x2_board_with_all_alive_cells(){
        Board board = new Board(Case.board2x2_with_all_alive_cells).next();
        assertThat(board.state()).isEqualTo(Case.board2x2_with_all_alive_cells);
    }

    @Test
    public void should_return_2x2_board_with_all_alive_cells_given_2x2_board_with_triangle_structure(){
        Board board = new Board(Case.board2x2_with_triangle_structure).next();
        assertThat(board.state()).isEqualTo(Case.board2x2_with_all_alive_cells);
    }

    @Test
    public void should_return_2x2_board_with_all_dead_cells_given_2x2_board_with_strip_structure(){
        Board board = new Board(Case.board2x2_with_strip_structure).next();
        assertThat(board.state()).isEqualTo(Case.board2x2_with_all_dead_cells);
    }
